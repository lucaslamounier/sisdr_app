...
$(document).ready(function() {
    ...
    imageryMap.on('draw:drawstart', function(e) {
        startDrawing($('#search'))
    });
    imageryMap.on('draw:editstart', function(e) {
        startDrawing($('#search'))
    });
    ...
    imageryMap.on('draw:deletestop', function(e) {
        stopDrawing($('#search'))
    });
    imageryMap.on('draw:editstop', function(e) {
        stopDrawing($('#search'))
    });
    ...
    function getRectangle(data) {
        data = data.split(',').map(function(a) {
            return parseFloat(a);
        });
