                ...
                link: function postLink(scope, element, attrs) {
                    ...
                    scope.control = new L.control.switch({
                        ...
                        scope.popup = function(content) {
                            ...
                            var layername = element.Identifica.split('.')[0];
                        ...
                        scope.layers = layers; scope.initialLayers = initialLayers; scope.wmsLayers = wmsLayers; scope.$watchCollection('layers', onLayersChange); scope.$watchCollection('initialLayers', onInitialLayersChange); scope.$watchCollection('wmsLayers', onWMSLayersChange);
